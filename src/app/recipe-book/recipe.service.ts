...
export class RecipeService {
  ...
  fetchImages(name){
    return this.httpClient.get("https://customsearch.googleapis.com/customsearch/v1?imgSize=HUGE&safe=active&key=AIzaSyBYKaDIBztMzKq9JuL0uRapCKC3p5RmN3w&cx=389ddf6134f07f332&searchType=image&q=" + name);
  }
